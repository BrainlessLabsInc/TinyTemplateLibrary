...
#include "blib/sccs/detail/node_types.hpp"
#include "blib/sccs/detail/add_port.hpp"
#include "blib/sccs/detail/add_action.hpp"
#include "blib/sccs/detail/add_repeat.hpp"
#include "blib/sccs/detail/add_stop.hpp"
#include "blib/sccs/detail/add_agent.hpp"
#include "blib/sccs/detail/runtime_types.hpp"
...
namespace detail
{
	...
	struct agent
	{
		...
		typedef blib::func::function<message_pnt (message_pnt)> action;
	...
	template< typename A, typename TT = sys::multi_thread_traits >
	struct runtime
	{
