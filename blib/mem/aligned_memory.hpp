...
namespace blib{namespace mem{namespace type_traits{
   ...
   namespace ttl_ns_impl{
      ...
      {
         static const bool value = (blib::meta::type_traits::alignment_of<TestType>::value == target) ;
         typedef typename blib::meta::if_c<value, TestType, char>::type type;
      };
      ...
      class type_with_alignment_imp
      {
         ...
         typedef typename ::blib::meta::if_c<
            is_aligned< ::blib::meta::type_traits::alignment_of<t1>::value,Align >::value
            , t1
            , max_align
         >::type align_t;

         static const unsigned int found = ::blib::meta::type_traits::alignment_of<align_t>::value;
      public:
      ...
      static const unsigned int alignment_of_max_align = ::blib::meta::type_traits::alignment_of<max_align>::value;
